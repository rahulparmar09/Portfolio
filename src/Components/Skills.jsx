...
const skills = [
  ...
  { name: "React.js", icon: "devicon-react-original", color: "text-cyan-400" },
  ...
  { name: "Firebase", icon: "devicon-firebase-plain", color: "text-yellow-400" },
  ...
  { name: "Vercel", icon: "devicon-vercel-plain", color: "text-white" },
